...
const DocumentsPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Verificación de Documentos | Exodus Intelligence</title>
                <meta name="description" content="Gestiona y verifica tus documentos para el proceso migratorio." />
            </Helmet>
            <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-950 text-white p-4 sm:p-8 flex items-center justify-center">
                ...
                >
                    ...
                    <p className="text-gray-400 mb-8">Esta sección está en construcción. Aquí podrás subir, gestionar y verificar tus documentos migratorios.</p>
