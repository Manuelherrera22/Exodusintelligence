...
// This function can be used if translations are needed inside the schema
...
const getProfileSchema = (t) => {
    ...
    return z.object({
        ...
        work_experience_years: z.preprocess(
            (val) => (val === '' || val === null ? 0 : Number(val)),
            z.number({ invalid_type_error: numberMsg }).min(0, "No puede ser negativo")
        ),
        ...
        savings_range: z.string().min(1, requiredMsg),
...
export const validationSchema = getProfileSchema(); // Use it without translation for now

export const formStepsConfig = [
    { id: 1, title: 'section1_title', component: FormStep1, fields: ['age', 'nationality', 'marital_status', 'gender', 'salud'] },
    { id: 2, title: 'section2_title', component: FormStep2, fields: ['education_level', 'field_of_study', 'is_title_validated', 'is_institution_recognized'] },
    { id: 3, title: 'section3_title', component: FormStep3, fields: ['occupation', 'work_experience_years', 'has_international_experience', 'is_remote_worker', 'nivel_tecnologico', 'perfil_emprendedor'] },
    { id: 4, title: 'section4_title', component: FormStep4, fields: ['english_level', 'has_language_certification', 'english_certification_score', 'languages'] },
    { id: 5, title: 'section5_title', component: FormStep5, fields: ['savings_range', 'has_work_offer', 'has_support_network', 'pais_familia'] },
    { id: 6, title: 'section6_title', component: FormStep6, fields: ['family_migration_plan', 'children_count', 'children_ages', 'partner_works'] },
    { id: 7, title: 'section7_title', component: FormStep7, fields: ['main_interest', 'target_country', 'willing_to_consider_other_countries', 'residency_type_interest', 'disponibilidad_para_viajar'] },
    { id: 8, title: 'section8_title', component: FormStep8, fields: ['has_valid_passport', 'has_active_visa', 'has_legal_antecedents'] },
    { id: 9, title: 'section9_title', component: FormStep9, fields: ['housing_plan', 'transport_plan', 'preferred_zone', 'interested_in_post_migration_services'] },
];